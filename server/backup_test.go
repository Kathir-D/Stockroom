...
func TestBackupRoutesRefuseAStudent(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodPost, "/admin/google/connect", nil},
		{http.MethodPost, "/admin/google/finish", map[string]any{"id": "x", "code": "{}"}},
		{http.MethodGet, "/admin/google", nil},
		{http.MethodGet, "/admin/google/folders", nil},
		{http.MethodGet, "/admin/local-folders", nil},
