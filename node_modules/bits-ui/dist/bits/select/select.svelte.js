...
import { afterSleep, afterTick, onDestroyEffect, attachRef, DOMContext, executeCallbacks, boxWith, } from "svelte-toolbelt";
...
export class SelectScrollDownButtonState {
    ...
    constructor(scrollButtonState) {
        ...
        watch([() => this.root.viewportNode, () => this.content.isPositioned], () => {
            ...
            if (!viewport || !this.content.isPositioned)
                return;
        ...
        watch(() => this.scrollButtonState.mounted, () => {
            ...
            this.scrollIntoViewTimer = afterSleep(5, () => {
                ...
                if (this.content.userHasScrolled)
                    return;
